...
<!-- 				<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script> 
 --> 
		...
		<body>
				...
				<div class="wrapper">
					 @include('layouts.includes._bootstrap_headertop')
						<div class="page-wrap">
								@include('layouts.includes._bootstrap_sidebar')
								<div class="main-content">
										 @yield('content')
								</div>
								
								<!-- @include('layouts.includes._bootstrap_rightsidebar') -->
								<!-- @include('layouts.includes._bootstrap_chatpanel') -->
								<!-- @include('layouts.includes._bootstrap_footer') -->
