<div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="index.html">
                            ...
                            <span class="text">Neysa Ibrahim</span>
                        </a>
                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-lavel">Master</div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-users"></i><span>Data Kontak</span></a>
                                    <div class="submenu-content">
                                        <a href="/kontak/customer" class="menu-item">Pelanggan</a>
                                        <a href="/kontak/supplier" class="menu-item">Supplier</a>
                                        <a href="/kontak/pegawai" class="menu-item">Pegawai</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="/barang"><i class="ik ik-package"></i><span>Data Barang</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="/tdt" class="menu-item">Table Datatable</a>
                ...
                <?php /**PATH C:\xampp\htdocs\laravel-crud\resources\views/layouts/includes/_bootstrap_sidebar.blade.php ENDPATH**/ ?>