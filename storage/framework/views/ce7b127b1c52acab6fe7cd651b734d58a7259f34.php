<header class="header-top" header-theme="light">
		<div class="container-fluid">
				<div class="d-flex justify-content-between">
						...
						<div class="top-menu d-flex align-items-center">
								<button onclick="repage()" type="button" class="nav-link ml-10 right-sidebar-toggle"><i class="ik ik-eye"></i></button>
...
<?php /**PATH C:\xampp\htdocs\laravel-crud\resources\views/layouts/includes/_bootstrap_headertop.blade.php ENDPATH**/ ?>